document.addEventListener('DOMContentLoaded', function () {
  ...
  let categoriaSelecionada = 'Income';  // Valor padrão
  ...
  btnEnviar.addEventListener('click', function (event) {
    ...
    const novoRegistro = {
      ...
      valor: valor,
      data: data,
      tipo: 'income',  // ajuste conforme necessário (expense ou income)
    ...
    .then(data => {
      ...
      if (data.success) {
        ...
        pElement.textContent = 'Income';
        categoriaSelecionada = 'Income';
      } else {
